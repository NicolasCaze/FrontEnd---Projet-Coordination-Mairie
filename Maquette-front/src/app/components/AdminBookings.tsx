...
import { FileText, Calendar, CheckCircle, Clock, XCircle, Filter, ArrowLeft, AlertCircle, User, Loader2 } from "lucide-react";
                    ...
                    <div className="flex flex-wrap gap-4 mb-2">
                      ...
                      {reservation.nombrePersonnes && (
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-xs">{reservation.nombrePersonnes} pers.</span>
                        </div>
                      )}
                    </div>

                    {reservation.motif && (
                      <p className="text-xs text-gray-500 italic mb-2 bg-gray-50 rounded px-2 py-1">"{reservation.motif}"</p>
                    )}
